...
void chatServer::handleClient(int client_fd, struct sockaddr_in cin){
    ...
    cout << "[客户端连接] IP: " << client_ip << " 端口: " << client_port << " FD: " << client_fd << endl;
    ...
    while (true){
        ...
        if (recv_len <= 0){
            cout << "[客户端断开] IP: " << client_ip << " 端口: " << client_port << endl;
            break;
        }
        ...
        case CHAT:
        {
            ...
            cout << "[聊天]: " << msg.name << ": " << msg.text << endl;
            broadcast(msg, client_fd);
            break;
        }
        case QUIT:
        {
            ...
            cout << "[退出]: " << msg.name << " 离开聊天" << endl;
            broadcast(msg, client_fd);
            break;
        }
        default:
        {
            cout << "[未知消息类型] FD: " << client_fd << endl;
            break;
        }
        }
